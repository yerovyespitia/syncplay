...
export function LocalFileRoomPlayer({
  ...
  function handleTimelineInput(event: ChangeEvent<HTMLInputElement>) {
    const video = videoRef.current;
  ...
  async function handleSubtitleFileChange(event: ChangeEvent<HTMLInputElement>) {
  ...
  return (
    <div className={`local-player-shell ${isTheaterMode ? "local-player-shell--theater" : ""}`}>
      <VideoPlayer
        ...
        activeSubtitleLines={activeSubtitleLines}
        ...
        onTimelineInput={handleTimelineInput}
        onToggleMute={toggleMute}
        onVolumeInput={handleVolumeInput}
        onToggleTheaterMode={() => {
          onTheaterModeChange(!isTheaterMode);
        }}
        onClosedCaptionsAction={handleClosedCaptionsAction}
        onReplaceSubtitles={handleReplaceSubtitles}
